...
describe('GET /api/agenda/available-times', () => {
  it('exige tenantId e date', async () => {
    const res = await GET(makeReq('http://localhost:3000/api/agenda/available-times?tenantId=11111111-1111-4111-8111-111111111111'));
  ...
  it('barra acesso não-autorizado ao tenant', async () => {
    ...
    const res = await GET(makeReq('http://localhost:3000/api/agenda/available-times?tenantId=11111111-1111-4111-8111-111111111111&date=2026-06-12'));
