    ...
    return (
        <div className="space-y-6 p-8 max-w-[1600px] mx-auto">
            ...
            <ConfirmModal
                ...
                title="Contato com Leads"
                message={
                    <div className="space-y-3">
                        <p>Este contato possui {controller.deleteWithDeals?.dealCount || 0} lead(s) vinculado(s):</p>
                        ...
                        <p className="text-red-500 dark:text-red-400 font-medium">Ao excluir, todos os leads também serão excluídos.</p>
                    </div>
                }
                    ...
                    <div className="space-y-2">
                        ...
                        {controller.viewMode === 'people' ? (
                            <p className="text-red-500 dark:text-red-400 text-sm">
                                Todos os leads vinculados também serão excluídos. Esta ação não pode ser desfeita.
                            </p>
                        ) : (
                            <p className="text-red-500 dark:text-red-400 text-sm">
                                Contatos/leads vinculados serão desvinculados da empresa antes da exclusão. Esta ação não pode ser desfeita.
                            </p>
                        )}
                    </div>
                }
