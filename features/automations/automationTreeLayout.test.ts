...
describe('layoutAutomationTree', () => {
  it('usa profundidade como coluna e centraliza cada pai entre os filhos', () => {
    ...
    const layout = layoutAutomationTree(steps, edges);
  ...
  it('mantém resultado determinístico quando os arrays chegam fora de ordem', () => {
    ...
    const first = layoutAutomationTree(steps, edges);
    const second = layoutAutomationTree([...steps].reverse(), [...edges].reverse());
