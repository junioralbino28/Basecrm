  ...
  return (
    <SettingsSection title="Campos Personalizados" icon={PenTool}>
      <p className="text-sm text-slate-600 dark:text-slate-300 mb-4 leading-relaxed">
        Crie campos específicos para o seu lead (ex: CNPJ, Data de Contrato, Origem). Eles aparecerão nos detalhes do lead.
      </p>
        ...
        {newFieldType === 'select' && (
          <div className="animate-in slide-in-from-top-2 fade-in duration-200">
            ...
            <input
              ...
              className="w-full bg-white dark:bg-black/30 border border-slate-200 dark:border-white/10 rounded-lg px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-brand-500 dark:text-white"
            />
            <p className="text-[10px] text-slate-400 mt-1">Essas opções aparecerão em um menu dropdown no detalhe do lead.</p>
          </div>
        )}
      </div>
